...
def test_filter_by_state_right(info_state_right):
    data, result = info_state_right
    assert filter_by_state(data) == result


def test_filter_by_state(info_state):
    test_1 = [
...
def test_filter_by_state(info_state, state, expected):
    assert filter_by_state(info_state, state) == expected


def test_sort_date_right(sort_data_right):
...
def test_sort_date_wrong(sort_data_right):
...
def test_sort_date_invalid_format():
...
def test_sort_date_missing_date():
